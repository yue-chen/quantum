...
class RyuDBTest(unittest2.TestCase):
    ...
    def test_key_allocation(self):
        ...
        key0 = db_api_v2.tunnel_key_allocate(session, network_id0)
        network_id1 = u'network-id-1'
        key1 = db_api_v2.tunnel_key_allocate(session, network_id1)
        key_list = db_api_v2.tunnel_key_all_list()
        ...
        db_api_v2.tunnel_key_delete(session, network_id0)
        key_list = db_api_v2.tunnel_key_all_list()
