...
class RyuQuantumPluginV2(db_base_plugin_v2.QuantumDbPluginV2,
    ...
    def __init__(self, configfile=None):
        ...
        db_api_v2.tunnel_key_init(cfg.CONF.OVS.tunnel_key_min,
    ...
    def _client_delete_network(self, net_id):
        client.ignore_http_not_found(lambda: self.client.delete_network(id))
        client.ignore_http_not_found(
            lambda: self.tun_client.delete_tunnel_key(id))
    ...
    def create_network(self, context, network):
        ...
        with session.begin(subtransactions=True):
            ...
            tunnel_key = db_api_v2.tunnel_key_allocate(session, net['id'])
            try:
    ...
    def delete_network(self, context, id):
        ...
        with session.begin(subtransactions=True):
            ...
            db_api_v2.tunnel_key_delete(session, id)
